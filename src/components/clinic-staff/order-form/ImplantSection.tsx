...
type ImplantSectionProps = {
  ...
  onChange: (updates: { trabajoSobreImplante?: boolean; informacionImplante?: ImplantInfo }) => void;
  errors?: {
...
export function ImplantSection({
  ...
  return (
    <div className="space-y-4">
      ...
      {trabajoSobreImplante && (
        <div className="space-y-4 rounded-lg bg-muted p-4 mt-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input
              ...
              onChange={(e) => handleImplantFieldChange('numeroImplantes', parseInt(e.target.value) || 1)}
              required
            ...
            <Select
              ...
              onChange={(e) => handleImplantFieldChange('tipoRestauracion', e.target.value as ImplantInfo['tipoRestauracion'])}
              required
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Select
              ...
              onChange={(e) => handleImplantFieldChange('tipoAditamento', e.target.value as ImplantInfo['tipoAditamento'])}
              required
            ...
            <Select
              ...
              onChange={(e) => handleImplantFieldChange('perfilEmergencia', e.target.value as ImplantInfo['perfilEmergencia'])}
              required
          ...
          <Select
            ...
            onChange={(e) => handleImplantFieldChange('condicionTejidoBlando', e.target.value as ImplantInfo['condicionTejidoBlando'])}
            required
