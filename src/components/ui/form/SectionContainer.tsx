...
import { ReactNode, useState, Children, cloneElement, isValidElement, ReactElement, forwardRef } from 'react';
...
export const SectionContainer = forwardRef<HTMLDivElement, SectionContainerProps>(
  ({ children, defaultCollapsed = false, collapsed, hasErrors = false, errorCount, onCollapseChange }, ref) => {
