...
export const SHADE_SYSTEMS = [
  ...
  { value: 'IVOCLAR_PE', label: 'Ivoclar Vivadent PE' },
  { value: 'IVOCLAR_CHROMASCOP', label: 'Ivoclar Vivadent Chromascop' },
  { value: 'IVOCLAR_AD_BLEACH', label: 'Ivoclar Vivadent A-D + Bleach' },
  { value: 'IPS_NATURAL_DIE', label: 'IPS Natural Die Material' },
  { value: 'ODILUX', label: 'Odilux' },
  { value: 'ODIDENT', label: 'Odident' },
  { value: 'ACRY_LUX', label: 'Acry Lux' },
  { value: 'ACRY_LUX_V', label: 'Acry Lux V' },
  { value: 'ACRY_PLUS', label: 'Acry Plus' },
  { value: 'ACRY_PLUS_V', label: 'Acry Plus V' },
  { value: 'TRUBYTE_NEW_HUE', label: 'Trubyte New Hue' },
  { value: 'KURARAY_NORITAKE', label: 'Kuraray Noritake' },
  { value: 'TRILUX_ACRYLIC', label: 'Trilux Acrylic Teeth' },
  { value: 'GC_INITIAL', label: 'GC INITIAL' },
  { value: 'CREATION_WILLI_GELLER', label: 'Creation Willi Geller' },
  { value: 'NORITAKE_TISSUE', label: 'Noritake Tissue' },
  { value: 'HASS_AMBER_MILL', label: 'Hass Amber Mill' },
